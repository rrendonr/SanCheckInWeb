# Single source for first 151 Pokémon names (Gen 1). Used by fetch_trends.py.
# Names match display; searchTerms used for Google Trends (no special chars).
POKEMON_151 = [
...
def search_term(name):
    """Google Trends search string (escape quotes for JS)."""
    return name + " Pokemon"
